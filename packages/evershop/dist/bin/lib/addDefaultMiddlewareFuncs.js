    ...
    app.use((request, response, next) => {
        ...
        if (!route || !isBuildRequired(route)) {
            ...
            if (!notFoundRoute.webpackCompiler) {
                notFoundRoute.webpackCompiler = webpack(createConfigClient(notFoundRoute));
            }
            ...
            if (!adminNotFoundRoute.webpackCompiler) {
                adminNotFoundRoute.webpackCompiler = webpack(createConfigClient(adminNotFoundRoute));
            }
