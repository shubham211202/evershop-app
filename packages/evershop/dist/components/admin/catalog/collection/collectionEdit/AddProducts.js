...
function AddProducts({ addProductApi, addedProductIDs, closeModal }) {
    ...
    return (React.createElement(ProductSkuSelector, { onSelect: addProduct, closeModal: closeModal, selectedChecker: (product) => addedProducts.find((p) => p == product.productId), onUnSelect: () => { } }));
}
