...
export default function PaymentStatusColumnHeader({ title, id, paymentStatusList = [], currentFilters = [] }) {
    ...
    return (React.createElement("th", { className: "column" },
        React.createElement("div", { className: "table-header payment-status-header" },
            React.createElement("div", { className: "title", style: { marginBottom: '1rem' } },
                React.createElement("span", null, title)),
            React.createElement("div", { className: "filter" },
                React.createElement(Select, { onChange: (e) => onChange(e), value: current, options: [{ value: 'all', text: 'All' }].concat(paymentStatusList) })))));
}
...
//# sourceMappingURL=PaymentStatusColumnHeader.js.map