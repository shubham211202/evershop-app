...
export function TaxClasses({ countries, getTaxClasses, classes }) {
    return (React.createElement(React.Fragment, null, classes.map((taxClass) => (React.createElement(TaxClass, { key: taxClass.uuid, taxClass: taxClass, getTaxClasses: getTaxClasses, countries: countries })))));
}
...
//# sourceMappingURL=TaxClasses.js.map