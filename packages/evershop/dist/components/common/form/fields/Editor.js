...
export default function Editor({ name, value = [], label, browserApi, deleteApi, uploadApi, folderCreateApi }) {
    ...
    return (React.createElement("div", { className: "editor form-field-container" },
                ...
                React.createElement("div", { className: "config p-3 flex justify-between bg-[#cccccc] items-center" },
                    ...
                    React.createElement("div", null,
                        React.createElement("a", { href: "#", onClick: (e) => {
                            ...
                            React.createElement(RemoveIcon, { color: "#d72c0d", width: 20, height: 20 })))),
        ...
        fileBrowser && (React.createElement(FileBrowser, { onInsert: (url) => {
