...
export default function ThumbnailRow({ id, areaProps }) {
    return (React.createElement("td", null,
        React.createElement("div", { className: "grid-thumbnail text-border border border-divider p-3 rounded flex justify-center", style: { width: '6rem', height: '6rem' } },
            areaProps.row[id] && (React.createElement("img", { className: "self-center", src: areaProps.row[id], alt: "" })),
            !areaProps.row[id] && (React.createElement("svg", { className: "self-center", xmlns: "http://www.w3.org/2000/svg", width: "2rem", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
