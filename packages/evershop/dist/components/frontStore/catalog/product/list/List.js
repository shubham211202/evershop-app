...
export default function ProductList({ products = [], countPerRow = 3 }) {
    if (products.length === 0) {
        return (React.createElement("div", { className: "product-list" },
            React.createElement("div", { className: "text-center" }, _('There is no product to display'))));
    }
    let className;
    switch (countPerRow) {
        case 3:
    ...
    return (React.createElement("div", { className: className }, products.map((p) => (React.createElement(Area, { id: "productListingItem", className: "listing-tem", product: p, key: p.productId, coreComponents: [
            {
