    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "stripe-form-heading flex justify-between" },
            ...
            React.createElement("div", { className: "self-center flex space-x-4" },
                React.createElement(Button, { onAction: testSuccess, title: "Test success", outline: true, variant: "interactive" }),
                React.createElement(Button, { onAction: testFailure, title: "Test failure", variant: "critical", outline: true })))));
}
TestCards.propTypes = {
