...
export function parseRoute(jsonPath, isAdmin = false, isApi = false) {
    ...
    const methods = (routeJson === null || routeJson === void 0 ? void 0 : routeJson.methods.map((m) => m.toUpperCase())) || [];
    let routePath = routeJson === null || routeJson === void 0 ? void 0 : routeJson.path;
    if (validateRoute(methods, routePath, routePath) === true) {
        ...
        return {
            id: routeId,
            name: (routeJson === null || routeJson === void 0 ? void 0 : routeJson.name) || routeId,
            method: methods,
            path: routePath,
            isAdmin,
            isApi,
            ...
            payloadSchema,
            access: (routeJson === null || routeJson === void 0 ? void 0 : routeJson.access) || 'private'
        };
    }
    else {
        return null;
...
//# sourceMappingURL=scanForRoutes.js.map