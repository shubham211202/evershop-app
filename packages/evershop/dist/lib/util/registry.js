...
class Registry {
    ...
    async get(name, initValue, context, validator) {
        if (this.values[name]) {
            ...
            if (isEqual(initValue, this.values[name].initValue) &&
    ...
    addFinalProcessor(name, callback) {
        ...
        const processors = ((_a = this.values[name]) === null || _a === void 0 ? void 0 : _a.processors) || [];
...
export function getValueSync(name, initialization, context, validator) {
    ...
    if (typeof initialization === 'function') {
        ...
        const processors = ((_a = registry.values[name]) === null || _a === void 0 ? void 0 : _a.processors) || [];
        processors.unshift({
            callback: initialization,
            priority: 0
        });
