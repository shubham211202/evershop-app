...
export default () => {
    ...
    registerWidget({
        ...
        settingComponent: path.resolve(CONSTANTS.LIBPATH, '../components/admin/widgets/CollectionProductsSetting.js'),
        component: path.resolve(CONSTANTS.LIBPATH, '../components/frontStore/widgets/CollectionProducts.js'),
        defaultSettings: {
            collection: null,
            count: 4
        },
