            ...
            modal.state.showing && (React.createElement("div", { className: modal.className, onAnimationEnd: modal.onAnimationEnd },
                React.createElement("div", { className: "modal-wrapper flex self-center justify-center items-center", tabIndex: -1, role: "dialog" },
                    React.createElement("div", { className: "modal" },
                        React.createElement(AddProducts, { addProductApi: addProductApi, closeModal: closeModal, addedProductIDs: data.collection.products.items.map((p) => p.productId) }))))),
                        ...
                        React.createElement("div", { className: "flex justify-between" },
                            React.createElement("div", null,
                                React.createElement("i", null,
                                    ...
                                    " items")),
                            React.createElement("div", null, data.collection.products.total > 10 && (React.createElement("div", { className: "flex justify-between gap-4" },
