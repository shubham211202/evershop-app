...
export class AttributeGroupCollection {
    ...
    async init(filters = []) {
        ...
        attributeGroupCollectionFilters.forEach((filter) => {
            ...
            if (filter.key === '*' || check) {
                filter.callback(this.baseQuery, check === null || check === void 0 ? void 0 : check.operation, check === null || check === void 0 ? void 0 : check.value, currentFilters);
            }
        });
...
//# sourceMappingURL=AttributeGroupCollection.js.map