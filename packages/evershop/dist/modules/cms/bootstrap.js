...
export default () => {
    ...
    registerWidget({
        type: 'text_block',
        settingComponent: path.resolve(CONSTANTS.LIBPATH, '../components/admin/widgets/TextBlockSetting.js'),
        component: path.resolve(CONSTANTS.LIBPATH, '../components/frontStore/widgets/TextBlock.js'),
        name: 'Text block',
    ...
    registerWidget({
        type: 'basic_menu',
        settingComponent: path.resolve(CONSTANTS.LIBPATH, '../components/admin/widgets/BasicMenuSetting.js'),
        component: path.resolve(CONSTANTS.LIBPATH, '../components/frontStore/widgets/BasicMenu.js'),
        name: 'Menu',
    ...
    const parseMenus = (data) => {
        if ((data === null || data === void 0 ? void 0 : data.type) !== 'basic_menu') {
            return data;
        }
