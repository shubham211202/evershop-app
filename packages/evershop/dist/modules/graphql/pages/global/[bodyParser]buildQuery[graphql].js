...
export default async (request, response, next) => {
    ...
    if (isDevelopmentMode()) {
        ...
        if (response.statusCode === 404) {
            if ((_a = request.currentRoute) === null || _a === void 0 ? void 0 : _a.isAdmin) {
        ...
        query = outputFileSystem.readFileSync(path.join(outputPath, 'query.graphql'), 'utf8');
    }
    else if (isProductionMode()) {
        const routes = getRoutes();
        let route;
        if (response.statusCode === 404) {
            if ((_b = request.currentRoute) === null || _b === void 0 ? void 0 : _b.isAdmin) {
        ...
        query = readFileSync(path.resolve(CONSTANTS.BUILDPATH, subPath, 'server/query.graphql'), 'utf8');
    }
    ...
    if (query) {
        ...
        try {
            ...
            if ((currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.isAdmin) === false ||
                ['widgetNew', 'widgetEdit'].includes(currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.id)) {
                applicableWidgets = widgetInstances.map((widget) => {
                    ...
                    const componentPath = (currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.isAdmin)
                        ? widgetSpecs.settingComponent
                        : widgetSpecs.component;
                    const componentKey = (currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.isAdmin)
            ...
            if (applicableWidgets.length > 0) {
                applicableWidgets.forEach((widget) => {
                    ...
                    queryStr = Object.keys(json.queries).reduce((acc, key) => {
                        if (!enabledWidgets.find((widget) => widget.componentKey === key ||
...
//# sourceMappingURL=%5BbodyParser%5DbuildQuery%5Bgraphql%5D.js.map