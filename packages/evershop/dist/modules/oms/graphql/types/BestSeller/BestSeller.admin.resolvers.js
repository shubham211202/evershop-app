...
export default {
    Query: {
        bestSellers: async () => {
            ...
            query
                .groupBy('order_item.product_id', 'product.product_id', 'product_description.product_description_id', 'product_inventory.product_inventory_id', 'product_image.product_image_id')
...
//# sourceMappingURL=BestSeller.admin.resolvers.js.map