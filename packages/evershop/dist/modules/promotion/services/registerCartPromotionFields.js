...
export function registerCartPromotionFields(fields) {
    ...
    [
            ...
            resolvers: [
                async function resolver() {
                    ...
                    if (!priceIncludingTax) {
                        ...
                        return toPrice(this.getData('sub_total_incl_tax') -
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    return toPrice(this.getData('sub_total_with_discount') +
                        this.getData('tax_amount'));
                }
            ],
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    return toPrice(this.getData('sub_total_with_discount_incl_tax') +
...
//# sourceMappingURL=registerCartPromotionFields.js.map